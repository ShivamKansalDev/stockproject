  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}
        ...
        <View style={{ ...styles.googleButton, marginBottom: 25 }}>
          <View style={{ width: 30, height: 30 }}>
            <Image source={require('../../Images/google.png')} style={{ width: '100%', height: '100%', resizeMode: "cover" }} />
          </View>
          <Text style={{
            marginLeft: 10, color: 'black', fontWeight: 'bold',
            fontSize: 16
        ...
        <TextInput
          ...
          label="Email"
          theme={{ colors: { text: "red", accent: "red", primary: "#0f9764", placeholder: "red", background: "transparent" } }} underlineColor="#d1d1d3" underlineColorAndroid="#f5f5f5"
