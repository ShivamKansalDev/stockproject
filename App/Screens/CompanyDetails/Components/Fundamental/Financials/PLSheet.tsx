...
import { getPLStatement } from '../../../../services/CompanyService';
...
import BANKS from "./PLColumnsInfo/BANKS.json";
import BANKC from "./PLColumnsInfo/BANKC.json";
import FINS from "./PLColumnsInfo/FINS.json";
import FINC from "./PLColumnsInfo/FINC.json";
import MANS from "./PLColumnsInfo/MANS.json";
import MANC from "./PLColumnsInfo/MANC.json";
import INSS from "./PLColumnsInfo/INSS.json";
import INSC from "./PLColumnsInfo/INSC.json";
import { ColumnInfo } from '../../../../model/ColumnInfo';
import { groupingColDef, StyledDataGrid } from '../StyledDataGrid';
...
function PLSheet(co_code: string, displayType: string, load: boolean) {
            ...
            <>
                ...
                >
                    <DialogContent dividers
                        style={{
                            width: (data && data.columns && data.columns.length > 0) ? `${150 * (data.columns.length - 1) + 120}px` : '300px',
                            //height: "300px" 
                        }}
                    >
                        <StyledDataGrid
    ...
    useEffect(() => {
        async function fetchData() {
            if (load === true) {
                try {
                    const response = await getPLStatement(co_code, alignment);
