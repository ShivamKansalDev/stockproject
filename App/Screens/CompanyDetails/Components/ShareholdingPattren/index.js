...
export const data = [
  {id: 0, name: 'Shareholding Pattrens', isActive: false, value: 'Shareholding Pattrens'},
  {id: 1, name: 'Top Shareholders', isActive: false, value: 'Top Shareholders'},
 
 
];
const ShareholdingPattren = () => {
        ...
        renderItem={({item, index}) => {
          ...
          return (
            <TouchableOpacity
              ...
              <Entypo name= {item.isActive?"chevron-thin-up":"chevron-thin-down"} size={20} color="black" />
            </TouchableOpacity>
          );
        }}
...
export default ShareholdingPattren
